...
def dealer_hits(carddeck, dealer, player_choice)
  ...
  if dealer.include?("Ace") && (dealer_total + 10) >= 17 && ((dealer_total + 10) <= 21) #added last condition (r3-a)
...
if dealer_hand.include?("Ace") && dealer_total == 21
  ...
  if player1_hand.include?("Ace") && player1_total == 21
